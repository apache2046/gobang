...
class Policy_Value(torch.nn.Module):
    def __init__(self):
        ...
        self.backbone = Sequential(
            #15x15
            Conv2d(in_channels=3, out_channels=128, kernel_size=3, stride=1, padding=1, bias=False),
            BatchNorm2d(128),
            ReLU(),
        ...
        # )
        self.policy_head = Sequential(
            Conv2d(in_channels=128, out_channels=32, kernel_size=1, stride=1, bias=False),
            BatchNorm2d(32),
            ReLU(),
            Flatten(),
